...
const Quiz = () => {
  ...
  const fetchQuizs = async () => {
    try {
      const response = await axios.get(`http://192.168.178.122:5000/allQuizByRecruter/65efc476236182db492bbe99`);
  ...
  const handleDelete = async (id) => {
    try {
      ...
      if (result.isConfirmed) {
        await axios.delete(`http://192.168.178.122:5000/delete_quiz/${id}`);
